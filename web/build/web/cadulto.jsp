...
<%@page import="ModeloDAO.AdultoMayor"%>
<%@page import="ModeloVO.AdultoMayor"%>
  <!DOCTYPE html>
  <html lang="en">
            ...
            <form name="form1" method="post" action="AdultoMayor">
             ...
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="IDAM"  placeholder="Identificación Adulto Mayor">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Adulto Mayor </label>
                      <input type="text" class="form-control form-control-user" name="NombreAM" placeholder="Nombres del Adulto Mayor">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="ApellidoAM"  placeholder="Apellidos Adulto Mayor">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FechaAM">Fecha de Nacimiento </label>
                      <input type="date" class="form-control form-control-user" name="FechaAM" >
                </div>
                  </div>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select type="number" class="form-control form-control-user" name="GeneroAM">
                  ...
                  <button class="btn btn-primary"> Añadir</button>
           		...
           		<label class="alert-primary">
                          ...
                          <strong>¡Èxito!</strong> El adulto mayor ha sido añadido en el sistema
                      </div>
                                  <%}%>  
                              </label><br>
