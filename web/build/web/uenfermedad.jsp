        ...
        <div id="content">
          ...
          <div class="container-fluid">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="NombreE"  placeholder="Nombre Enfermedad">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                      <label for="SintomaE">Sintomas Enfermedad </label>
                      <input type="text" class="form-control form-control-user" name="SintomaE" placeholder="Sintomas Enfermedad">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                   ...
                   <textarea class="form-control form-control-user" name="TratamientoE"  placeholder="Tratamientos de la Enfermedad"> </textarea>
                  </div>
