	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
	                	...
	                	<%
                            FamiliarVO famVO = (FamiliarVO) request.getAttribute("volleno");
	             ...
	             <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <input type="number" class="form-control form-control-user" name="IDF"   value="<%=famVO.getId_Fam()%>">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="NombreF">Nombres del familiar </label>
	                      <input type="text" class="form-control form-control-user" name="NombreF" value="<%=famVO.getNomb_Fam()%>">
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <input type="text" class="form-control form-control-user" name="ApellidoF" value="<%=famVO.getApel_Fam()%>">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="TelefonoF">Telefono</label>
	                      <input type="number" class="form-control form-control-user" name="TelefonoF"value="<%=famVO.getTelefono_Fam()%>">
	                </div>
	                  </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="CorreoF" value="<%=famVO.getEmail_Fam()%>" placeholder="Correo electronico">
	                      	</div>
	                       <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="FotoF">Foto del familiar </label>
	                      <input type="file" class="form-control form-control-user" name="FotoF" value="<%=famVO.getFot_Fam()%>">
	                </div>
	            </div>
	               ...
	               <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select class="form-control form-control-user" name="ParentescoF" required>
                                            ...
                                            <%if (famVO.getParen_Fam() == "Hijo") { %>
                                            <option value="Hijo">Hijo</option>
                                            <%} else if (famVO.getParen_Fam() == "Sobrino") {%>
                                            <option value="Sobrino">Sobrino</option>
                                            <%} else if (famVO.getParen_Fam() == "Tio") {%>
                                            <option value="Tio">Tio</option>
                                            <%} else if (famVO.getParen_Fam() == "Madrina") {%>
                                            <option value="Madrina">Madrina</option>
                                            <%} else if (famVO.getParen_Fam() == "Padrino") {%>
                                            <option value="Padrino">Padrino</option>
                                            <%} else if (famVO.getParen_Fam() == "Otro") {%>
