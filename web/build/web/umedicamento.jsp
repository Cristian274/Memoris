	        ...
	        <div id="content">
	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                ...
	                <!--<%
                            MedicamentoVO medVO = (MedicamentoVO) request.getAttribute("volleno");

                        %>-->
	                <div class="card-body">
	                	<div class="form-group row">
	                	<div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="IDF">ID Medicamento </label>
	                    <input type="number" class="form-control form-control-user" value="<%=medVO.getId_Med()%>"name="IDM" readonly>
	                  </div>
				</div>
	             ...
	             <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreM" value="<%=medVO.getId_Med()%>">
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="FechamM">Fecha vencimiento </label>
	                      <input type="date" class="form-control form-control-user" name="FechaM" value="<%=medVO.getFecha_Venci_Med()%>">
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <input type="file" class="form-control form-control-user" name="CompoM" value="<%=medVO.getCompo_Med()%>" >
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="CorreoF">Contraindicaciones </label>
	                      <input type="File" class="form-control form-control-user" name="ContraM" value="<%=medVO.getContraindi_Med()%>" >
	                  </div> 
	              </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="CantidadM" value="<%=medVO.getCant_Med()%>" >
	                      	</div>
	                      <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select class="form-control form-control-user" name="DosisM" required>
                                            ...
                                            <%if (medVO.getVia_Med() == "mg") {%>
                                            <option value="mg">mg</option>
                                            <%} else if (medVO.getVia_Med() == "g") {%>
                                            <option value="g">g</option>
                                            <%} else if (medVO.getVia_Med() == "ml") {%>
	               ...
	               <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreLM" value="<%=medVO.getNom_Lab_Med()%>">
	                      	</div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select class="form-control form-control-user" name="ViaM" required="">
                                            <option value="">Seleccione...</option>
                                            <%if (medVO.getVia_Med() == "Oral") {%>
                                            <option value="Oral">Oral</option>
                                            <%} else if (medVO.getVia_Med() == "Inyeccion") {%>
