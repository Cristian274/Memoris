           ...
           <div class="card shadow mb-4">
             ...
             <div class="form-group row">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                      <label for="nombre">Nombre de usuario del Administrador </label>
                      <input type="text" class="form-control form-control-user" name="nombre" placeholder="Nombre de usuario (Nickname)">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label for="nocomple">Nombres completos del Administrador </label>
                    <input type="text" class="form-control form-control-user" name="nocomple"  placeholder="Nombres Completos">
                  </div>
                 ...
                 <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input type="date" class="form-control form-control-user" name="contra" >
                </div>
              ...
              <label class="alert-primary">
                          ...
                          <strong>¡Éxito!</strong>  El Administrador ha sido añadido en el sistema
                      </div>
                                  <%}%>  
                              </label><br>
                          ...
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                          <strong>¡Error!</strong> No se ha podido añadir el Administrador
                      </div>    
                                  <%}%>  
                              </label>
