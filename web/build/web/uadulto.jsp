          ...
          <div class="container-fluid">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <%
           AdultoMayorVO aduVO = (AdultoMayorVO) request.getAttribute("volleno");
        ...
        %>
             ...
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="IDAM" value="<%=aduVO.getIdAdult()%>" placeholder="Identificación Adulto Mayor">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Adulto Mayor </label>
                      <input type="text" class="form-control form-control-user" name="NombreAM" placeholder="Nombres del Adulto Mayor"  value="<%=aduVO.getNombres_Adult()%>">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="ApellidoAM"  placeholder="Apellidos Adulto Mayor" value="<%=aduVO.getApellidos_Adult()%>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FechaAM">Fecha de Nacimiento </label>
                      <input type="date" class="form-control form-control-user" name="FechaAM"  value="<%=aduVO.getFecha_Adult()%>">
                </div>
                  </div>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <%if (aduVO.getGenero_Adult()=="f") {%>
                    	<option value="f">Femenino</option>
                      <%} else if (aduVO.getGenero_Adult()=="m") {%>
