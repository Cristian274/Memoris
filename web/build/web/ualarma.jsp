...
<!--	                	   <%
                            AlarmaVO alaVO = (AlarmaVO) request.getAttribute("volleno");

                        %>-->
                        <div class="form-group row">
	                	<div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="IDF">ID Alarma</label>	                   
	                  	 <input type="number" class="form-control form-control-user" value="<%=alaVO.getId_Alarm()%>" name="IDA" readonly>
	                  </div>
	              </div>
	             ...
	             <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="IDM">Id medicamento</label>
	                      	<input type="number" class="form-control form-control-user" value="<%=alaVO.getId_Medicamento()%>" name="IDA">
	                      	
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="ObservacionR">ID Cuidador</label>
	                      	<input type="number" class="form-control form-control-user" value="<%=alaVO.getId_Cuidador()%>">
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="IDAMR">Nombre medicamento </label>
	                     <input type="text" class="form-control form-control-user" name="NombreM" value="<%=alaVO.getNom_Med()%>">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	              ...
	              <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                     ...
	                     <input type="text" class="form-control form-control-user" name="CantidadM" value="<%=alaVO.getCantidad_Alarm()%>">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
