          ...
          <div class="container-fluid">
           <div class="card shadow mb-4">
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                      <label for="nombre">Nombre completos del usuario </label>
                      <input type="text" class="form-control form-control-user" name="nombre" placeholder="Nombre de usuario (Nickname)">
                </div>
            </div>
                 ...
                 <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input type="date" class="form-control form-control-user" name="contra1" >
                </div>
                 <div class="col-sm-6 mb-3 mb-sm-0">
...
<input type="Hidden" value="1" name="opcion">
              ...
              <label class="alert-primary">
                          ...
                          <strong>¡Éxito!</strong>  El Usuario ha sido Modificado en el sistema
                      </div>
                                  <%}%>  
                              </label><br>
