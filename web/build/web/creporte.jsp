                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <!--<label for="IDF">ID reporte </label>-->
                                    <input type="hidden" class="form-control form-control-user" value="" name="IDR" >
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" class="form-control form-control-user" value="<%=año + "-" + mes + "-" + dia%>" name="FechaR">

                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="ObservacionR">Observaciones </label>
                                        <textarea class="form-control form-control-user" name="ObservacionR" placeholder="Observaciones">  </textarea>
                                    </div>
                                </div>
                        ...
                        <label class="alert-primary">
                            ...
                            <div class="alert alert-success">
                                ...
                                <strong>Â¡Ãˆxito!</strong> El Reporte ha sido añadido en el sistema
                            </div>
                            <%}%>  
                        </label><br>
                        <label class="alert-danger">
                            ...
                            <div class="alert alert-danger">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>¡Error!</strong> No se ha podido añadir el reporte
                            </div>    
                            <%}%>  
                        </label>
