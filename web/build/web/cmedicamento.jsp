	          ...
	          <div class="container-fluid">
	             ...
	             <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreM" placeholder="Nombres del medicamento">
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="FechaM">Fecha vencimiento </label>
	                      <input type="date" class="form-control form-control-user" name="FechaM" placeholder="Fecha de vencimiento">
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <input type="file" class="form-control form-control-user" name="CompoM"  placeholder="Composicion">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="ContraM">Contraindicaciones </label>
	                      <input type="File" class="form-control form-control-user" name="ContraM" placeholder="Contraindicaciones">
	                  </div> 
	              </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="CantidadM" placeholder="Ej: 100">
	                      	</div>
	                      <div class="col-sm-6 mb-3 mb-sm-0">
	                    	 
	                  		<label for="DosisM">Dosis</label>
	                    <select class="form-control form-control-user" name="DosisM">
	               ...
	               <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreLM" placeholder="Laboratorio">
	                      	</div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select type="number" class="form-control form-control-user" name="ViaM">
	                    	<option value="">Seleccione...</option>
