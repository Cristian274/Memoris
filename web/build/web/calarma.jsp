          ...
          <!-- End of Topbar -->
	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                ...
	                <!-- <% int i=0;%>	
	                	<%int numero = (int)(Math.random()*999999+1111);%>-->
	             ...
	             <div class="form-group row">
	                  ...
	                  div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <select class="form-control form-control-user" name="IDM" required>
              ...
              <% }
                %>
	                ...
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="ObservacionR">Identificaci�n del Cuidador</label>
	                      <select class="form-control form-control-user" name="IDC" required>
                                    <option value="">seleccione.....</option>
                ...
                %>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                     ...
	                     <input type="text" class="form-control form-control-user" name="NombreM" placeholder="Nombre medicamento">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <option value="Inyecci�n">Inyecci�n</option>
	              ...
	              <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                     ...
	                     <input type="text" class="form-control form-control-user" name="CantidadM" placeholder="Cantidad">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
              ...
              <option value="ml">ml</option>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                     ...
	                     <input type="date" class="form-control form-control-user" name="FechaIA">
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="FechaFA">Fecha final</label>
	                  		<input type="date" class="form-control form-control-user" name="FechaFA">
	                  </div> 
	              </div>
              ...
              <option value="24">Cada 24 Horas</option>
	              ...
	              <label class="alert-primary">
	                        ...
	                        <strong>¡Èxito!</strong> La alarma ha sido a�adida en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido a�adir la alarma
	                    </div>    
	                                <%}%>  
	                            </label>
