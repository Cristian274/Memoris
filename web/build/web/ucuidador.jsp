          ...
          <div class="container-fluid">
             ...
             <div class="card shadow mb-4">
                ...
                <div class="card-body">
                	 ...
                	 <%
          CuidadorVO cuiVO = (CuidadorVO) request.getAttribute("volleno");

        %>



        <<form action="Cuidador" method="post">
<div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="IDU">Identificación Cuidador </label>
                    <input type="number" class="form-control form-control-user" name="IDU" value="<%=cuiVO.getId_Cuid()%>"  placeholder="IdentificaciÃ³n Cuidador">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Cuidador </label>
                        <input type="text" class="form-control form-control-user" name="NombreC" placeholder="Nombres del Cuidador" value="<%=cuiVO.getNomb_Cuid() %>">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ApellidoAM">Apellidos del Cuidador </label>
                        <input type="text" class="form-control form-control-user" name="ApellidoC"  placeholder="Apellidos Cuidador"value="<%=cuiVO.getApel_Cuid()%>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="TelefonoC">Teléfono </label>
                      <input type="number" class="form-control form-control-user" name="TelefonoC" >
                </div>
                  </div>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="CorreoC">Correo Electrónico del Cuidador </label>
                        <input type="Email" class="form-control form-control-user" name="CorreoC"  placeholder="Ejemplo: Example12@gmail.com"value="<%=cuiVO.getEmail_Cuid()%>">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FotoC">Foto Del Cuidador </label>
                        <input type="file" class="form-control form-control-user" name="FotoC" value="<%=cuiVO.getFoto_Cuid()%>" >
                </div>
                  </div>
