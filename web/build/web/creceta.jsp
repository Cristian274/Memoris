                    ...
                    <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="FechaR">Fecha  en que fue realizada la Receta </label>
                                        <input type="date" class="form-control form-control-user" name="FechaR" ></div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        enVO = listar2.get(a);%>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="CantidadMR" placeholder="Ej: 100">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <select  class="form-control form-control-user" name="DosisMR">
                                            <option value="">Seleccione...</option>
                        ...
                        <label class="alert-primary">
                            ...
                            <div class="alert alert-success">
                                ...
                                <strong>Éxito!</strong> La receta ha sido añadido en el sistema
                            </div>
                            <%}%>  
                        </label><br>
