          ...
          <div class="container-fluid">
             ...
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="number" class="form-control form-control-user" name="IDC"  placeholder="Identificación Cuidador">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreC">Nombres del Cuidador </label>
                      <input type="text" class="form-control form-control-user" name="NombreC" placeholder="Nombres del Cuidador">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ApellidoC">Apellidos del Cuidador </label>
                    <input type="text" class="form-control form-control-user" name="ApellidoC"  placeholder="Apellidos Cuidador">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="Email" class="form-control form-control-user" name="CorreoC"  placeholder="Ejemplo: Example12@gmail.com">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FotoC">Foto Del Cuidador </label>
                      <input type="file" class="form-control form-control-user" name="FotoC" >
                </div>
                  </div>
