                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="number" class="form-control form-control-user" name="IDF"  placeholder="IdentificaciÃ³n del familiar">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="NombreF">Nombres del familiar </label>
                                        <input type="text" class="form-control form-control-user" name="NombreF" placeholder="Nombres del familiar">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="ApellidoF"  placeholder="Apellidos del familiar">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="TelefonoF">Telefono</label>
                                        <input type="number" class="form-control form-control-user" name="TelefonoF" placeholder="Telefono">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" name="CorreoF" placeholder="Correo electronico">
                                    </div>
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="FotoF">Foto del familiar </label>
                                        <input type="file" class="form-control form-control-user" name="FotoF">
                                    </div>
                                </div>
                                ...
                                aduVO = listar.get(i);%>
                                            ...
                                            %>
                                             ...
                                             <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label for="TelF">Teléfono del Familiar</label>
                                        <input type="number" class="form-control form-control-user" name="TelF">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <select type="number" class="form-control form-control-user" name="ParentescoF">
