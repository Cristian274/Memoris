                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consulta receta</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th scope="col">Id</th>
                                                     ...
                                                     <th scope="col">Identificación Adulto</th>
                                            ...
                                            <%
                                                RecetaVO recVO = new RecetaVO();
                                                RecetaDAO recDAO = new RecetaDAO();
                                                ArrayList<RecetaVO> listareceta = recDAO.listarreceta();

                                                for (int i = 0; i < listareceta.size(); i++) {

                                                    recVO = listareceta.get(i);
                                            %>

                                            <tbody>
                                                <tr>

                                                    <td><%= recVO.getId_Rec()%></td>
                                                    <td><%= recVO.getFecha_Rec()%></td>
                                                    <td><%= recVO.getId_Adult()%></td>
                                                    <td><%= recVO.getId_enf()%></td>
                                                    <td><%= recVO.getNommed_recmed()%></td>
                                                   <td><%= recVO.getDosis_recmed()%></td> 
                                                    <td><%= recVO.getViaadmin_recmed()%></td>
                        ...
                        <label class="alert-danger">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <strong>Â¡Error!</strong> La receta mèdica no existe en el sistema
                            </div>    
                            <%}%>  
                        </label>
                    </div>
