...
<%@page import="ModeloVO.ReporteVO"%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consulta reporte</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <%
                                                ...
                                                ArrayList<ReporteVO> listareporte = repDAO.listarreporte();
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><%= repVO.getId_Reporte()%></td>
                                                    <td><%= repVO.getFecha_Reporte()%></td>
                                                    <td><%= repVO.getId_Adult()%></td>
                                                    <td><%= repVO.getComportamiento()%></td>
                        ...
                        <label class="alert-danger">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <strong>Â¡Error!</strong> El reporte no existe en el sistema
                            </div>    
                            <%}%>  
                        </label>
                    </div>
