	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                <div class="card-header py-3">
	                  ...
	                  <h6 class="m-0 font-weight-bold text-primary">Actualizar Alarma</h6>
	                </div>
	                <div class="card-body">

	                	   <%
                            String id=request.getParameter("id");
                           AlarmaVO alaVO=new AlarmaVO();
                          AlarmaDAO enDAO=new AlarmaDAO();
                          ArrayList<AlarmaVO> listar=enDAO.consultarId(id);
                        ...
                        %>
	                  	 ...
	                  	 <input type="hidden" value="<%=alaVO.getId_Alarm()%>" name="IDA" >



	             <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
                        <label for="ID">Id Alarma</label>
                          <input type="number"  readonly class="form-control form-control-user" value="<%=alaVO.getId_Alarm()%>" name="ID">
	                    	...
	                    	<label for="IDM">Id medicamento</label>
	                      	<input type="number" class="form-control form-control-user" value="<%=alaVO.getId_Medicamento()%>" name="IDA" pattern="[0-9]{1,12}" required title="Solo se acepta números, cantidad min/max de números:1/12">
	                ...
	                <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <select class="form-control form-control-user" name="ViaM" required>
                                            ...
                                            <%if (alaVO.getVia_Adminis_Alarm() == "Oral") {%>
                                            <option value="Oral">Oral</option>
                                            <%} else if (alaVO.getVia_Adminis_Alarm() == "Inyección") {%>
	                     ...
	                     <input type="text" class="form-control form-control-user" name="CantidadM" value="<%=alaVO.getCantidad_Alarm()%>" pattern="[0-9]{1,4}" required title="Solo se acepta números, y solo se permiten como máximo 4 carácteres">
	                  </div>
	              </div>
	              ...
	              <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="DosisM">Dosis</label>
	                  		 <select class="form-control form-control-user" name="DosisM" required>
                                            <option value="">Seleccione...</option>
                                            <%if (alaVO.getVia_Adminis_Alarm() == "mg") {%>
                                            <option value="mg">mg</option>
                                            <% } else if (alaVO.getVia_Adminis_Alarm() == "g") {%>
                                            <option value="g">g</option>
                                            <%} else if (alaVO.getVia_Adminis_Alarm() == "ml") {%>
	                     ...
	                     <input type="date" class="form-control form-control-user" name="FechaIA" value="<%=alaVO.getFecha_Inicio_Alarm()%>">
	                  </div>
	              </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		...
	                  		<input type="date" class="form-control form-control-user" name="FechaFA" value="<%=alaVO.getFecha_Final_Alarm()%>">
	                  </div> 
                          <div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="FrecuenciaA">Frecuencia</label>
	                      <select class="form-control form-control-user" name="FrecuenciaA" required>
                                            <option value="">Seleccione...</option>
                                            <%if (alaVO.getFrecuencia_Medica_Alarm() == "1") {%>
                                            <option value="1">Cada 1 Hora</option>
                                            <%} else if (alaVO.getFrecuencia_Medica_Alarm() == "2") {%>
                                            <option value="2">Cada 2 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "3") {%>
                                            <option value="3">Cada 3 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "4") {%>
                                            <option value="4">Cada 4 Hora</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "5") {%>
                                            <option value="5">Cada 5 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "6") {%>
                                            <option value="6">Cada 6 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "7") {%>
                                            <option value="7">Cada 7 Hora</option>
                                            <%} else if (alaVO.getFrecuencia_Medica_Alarm() == "8") {%>
                                            <option value="8">Cada 8 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "9") {%>
                                            <option value="9">Cada 9 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "10") {%>
                                            <option value="10">Cada 10 Hora</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "11") {%>
                                            <option value="11">Cada 11 Horas</option>
                                            <%} else if (alaVO.getFrecuencia_Medica_Alarm() == "12") {%>
                                            <option value="12">Cada 12 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "13") {%>
                                            <option value="13">Cada 13 Hora</option>
                                            <%} else if (alaVO.getFrecuencia_Medica_Alarm() == "14") {%>
                                            <option value="14">Cada 14 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "15") {%>
                                            <option value="15">Cada 15 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "16") {%>
                                            <option value="16">Cada 16 Hora</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "17") {%>
                                            <option value="17">Cada 17 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "18") {%>
                                            <option value="18">Cada 18 Horas</option>
                                            <%} else if (alaVO.getFrecuencia_Medica_Alarm() == "19") {%>
                                            <option value="19">Cada 19 Hora</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "20") {%>
                                            <option value="20">Cada 20 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "21") {%>
                                            <option value="21">Cada 21 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "22") {%>
                                            <option value="22">Cada 22 Hora</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "23") {%>
                                            <option value="23">Cada 23 Horas</option>
                                            <% } else if (alaVO.getFrecuencia_Medica_Alarm() == "24") {%>
	              ...
	              <label class="alert-primary">
	                        ...
	                        <strong>¡Èxito!</strong> La alarma ha sido modificada en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido modificar la alarma
	                    </div>    
	                                <%}%>  
	                            </label>
