                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consultar enfermedad</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th >Tratamientos  de la Enfermedad</th>
                                                    <th>Opción</th>
                                            ...
                                            <tbody>
                                                <%  EnfermedadVO enfVO = new EnfermedadVO();
                                                    ...
                                                    ArrayList<EnfermedadVO> listaEnfermedad = enferDAO.listarEnfermedad();

                                                    for (int i = 0; i < listaEnfermedad.size(); i++) {

                                                        enfVO = listaEnfermedad.get(i);
                                                %>
                                                <tr>
                                                    <td ><%= enfVO.getId_Enf()%> </td>
                                                    <td><%= enfVO.getNom_Enf()%></td>
                                                    <td><%= enfVO.getSint_Enf()%></td>
                                                    <td><%= enfVO.getTrat_Enf()%></td>
                                                    <td> <a href="uenfermedad.jsp?id=<%=enfVO.getId_Enf()%>">Modificar</a></i></td>
