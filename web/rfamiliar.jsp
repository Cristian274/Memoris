                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consultar familiar</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    ArrayList<FamiliarVO> listaFamiliar = famDAO.listarfamiliar();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= famVO.getId_Fam()%></td>
                                                    <td><%= famVO.getNomb_Fam()%></td>
                                                    <td><%= famVO.getApel_Fam()%></td>
                                                    <td><%= famVO.getParen_Fam()%></td>
                                                    <td><%= famVO.getEmail_Fam()%></td>
                                                   
                                                    <td><%= famVO.getFot_Fam()%></td>
                                                    <td><%= famVO.getId_Adult()%></td>
                                                    <td><%= famVO.getId_Usuario()%></td>
                                                    <td> <a href="ufamiliar.jsp?id=<%=famVO.getId_Fam()%>">Modificar</a></i></td>
                                                    <%}%>
                                                </tr>
                        ...
                        <label class="alert-danger">
                            ...
                            <div class="alert alert-danger">
                                ...
                                <strong>Â¡Error!</strong> El familiar no existe en el sistema
                            </div>    
                            <%}%>  
                        </label>
                    </div>
