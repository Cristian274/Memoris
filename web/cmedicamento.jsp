	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
	                    ...
	                    <input type="hidden"  value="<%=num%>" name="IDM">
	             ...
	             <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreM" placeholder="Nombres del medicamento" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="FechamM">Fecha vencimiento </label>
	                      <input type="date" class="form-control form-control-user" required name="FechaM" placeholder="Fecha de vencimiento">
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="CompoM">Composición </label>
	                    <input type="file" class="form-control form-control-user" name="CompoM"  placeholder="Composicion" required>
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="CorreoF">Contraindicaciones </label>
	                      <input type="File" class="form-control form-control-user" name="ContraM" placeholder="Contraindicaciones" required>
	                  </div> 
	              </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="CantidadM" placeholder="Ej: 100"pattern="[0-9]{1,4}" required title="Solo se acepta números y máximo 4 carácteres">
	                      	</div>
	                      <div class="col-sm-6 mb-3 mb-sm-0">
	                    	 
	                  		<label for="DosisM">Dosis</label>
	                    <select type="number" class="form-control form-control-user" name="DosisM" required>
	               ...
	               <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="NombreLM" placeholder="Laboratorio" pattern="[A-Za-zñÑáéíóú\s]{2,15}" required title="Solo se acepta letras y solo puedes digitar 25 letras">
	                      	</div>

	                  <div class="col-sm-6 mb-3 mb-sm-0">

	                  	<label for="ViaM">Via</label>
	                    <select type="number" required class="form-control form-control-user" name="ViaM" required>
	                    	<option value="">Seleccione...</option>
	              ...
	              <label class="alert-primary">
	                        ...
	                        <strong>¡Èxito!</strong> El medicamento ha sido añadido en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido añadir el medicamento
	                    </div>    
	                                <%}%>  
	                            </label>
