          ...
          <!-- End of Topbar -->
	          ...
	          <div class="container-fluid">
	             ...
	             <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
	                    ...
	                    <input type="hidden" value="<%=num%>" name="IDU" >
	                  
	             <div class="form-group row">
	                 
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="NombreU">Nombre de Usuario</label>
	                      <input type="text" class="form-control form-control-user" name="nombre" placeholder="Correo electrónico" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,25}" required title="Digite un correo válido ">
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="contra">Contraseña</label>
	                      <input type="Password" class="form-control form-control-user" name="contra" placeholder="Contraseña">
	                      	</div>
	            </div>
	                  ...
	                  <div class="form-group row">
	                      ...
	                      <input type="nocomple" class="form-control form-control-user" name="nocomple" placeholder="Ej: Manuel Rodriguez">
	                
	               <% if (usuVO.getRol().equals("1")) {%>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                         
                        <label for="roles">Roles</label>
                      <select type="number" class="form-control form-control-user" name="roles" required>
              ...
              <%}%>
	              ...
	              <label class="alert-primary">
	                        ...
	                        <strong>¡Éxito!</strong> El usuario ha sido añadido en el sistema
	                    </div>
	                                <%}%>  
	                            </label>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido añadir el usuario
	                    </div>    
	                                <%}%>  
	                            </label>
