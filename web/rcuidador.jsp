          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Consultar cuidador</h6>
                  </div>
                  <div class="card-body">
    ...
    <thead>
        <tr>
                ...
                <%
                                    ...
                                    CuidadorVO cuidVO = new CuidadorVO();
                                    CuidadorDAO cuidDAO = new CuidadorDAO();
                                    ArrayList<CuidadorVO> listaCuidador = cuidDAO.listarCuidador();

                                    for (int i = 0; i < listaCuidador.size(); i++) {

                                        cuidVO = listaCuidador.get(i);
                                %>
                                <tbody>
                                            <tr>
                                        <td ><%= cuidVO.getId_Cuid()%> </td>
                                        <td><%= cuidVO.getNomb_Cuid()%></td>
                                        <td><%= cuidVO.getApel_Cuid()%></td>
                                        <td><%= cuidVO.getEmail_Cuid()%></td>
                                        <td><%= cuidVO.getTelefono_Cuid()%></td>
                                        <td><%= cuidVO.getFoto_Cuid()%></td>
                                        <td><%= cuidVO.getId_usuario()%></td>
                                        <td> <a href="ucuidador.jsp?id=<%=cuidVO.getId_Cuid()%>">Modificar</a></i></td>
                                            <%}%>
