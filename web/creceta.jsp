...
<%@page import="ModeloVO.EnfermedadVO"%>
<%@page import="ModeloVO.EnfermedadVO"%>
<%@page import="ModeloDAO.EnfermedadDAO"%>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="Receta">

                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <!--<label for="IDF">ID Receta </label>-->
                                    ...
                                    %>
                                    <input type="hidden" name="FechaR" value="<%=año + "-" + mes + "-" + dia%>">

                                    <div class="form-group row">

                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="IDAMR">CC adulto mayor</label>
                                            <select class="form-control form-control-user" name="IDAMR" required>
                                                <option value="" selected>Seleccione.....</option>
                                                <% AdultoMayorVO usVO = new AdultoMayorVO();
                                                    AdultoMayorDAO usDAO = new AdultoMayorDAO();
                                                    ArrayList<AdultoMayorVO> listar = usDAO.listaradulto();
                                                    for (int a = 0; a < listar.size(); a++) {

                                                        usVO = listar.get(a);%>
                                                <option value="<%= usVO.getIdAdult()%>"><%= usVO.getIdAdult() + "-" + usVO.getNombres_Adult() + " " + usVO.getApellidos_Adult()%></option>
                                                <%}
                                                %>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="IDER">Id enfermedad </label>
                                            <select class="form-control form-control-user" name="IDER" required>
                                                <option value=""> seleccione...</option>
                                                <% EnfermedadVO enVO = new EnfermedadVO();
                                                    EnfermedadDAO enDAO = new EnfermedadDAO();
                                                    ArrayList<EnfermedadVO> listar2 = enDAO.listarEnfermedad();
                                                    for (int a = 0; a < listar2.size(); a++) {

                                                    enVO = listar2.get(a);%>
                                                <option value="<%= enVO.getId_Enf()%>"> <%= enVO.getId_Enf() + "-" + enVO.getNom_Enf()%></option>
                                                <%}
                                                %>
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="CantidadMR">Cantidad </label>
                                            <input type="number" class="form-control form-control-user" name="CantidadMR" placeholder="Ej: 100" pattern="[1-9]{1,4}" title="solo se permite números y solo se permiten 4 números como máximo">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <label for="DosisMR">Dosis</label>
                                            <select type="text" class="form-control form-control-user" name="DosisMR" required>
                                                <option value="">Seleccione...</option>
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="ViaMR">Via</label>
                                            <select class="form-control form-control-user" name="ViaMR"required >
                                                <option value="">Seleccione...</option>
                        ...
                        <label class="alert-primary">
                            ...
                            <div class="alert alert-success">
                                ...
                                <strong>¡Éxito!</strong> La receta ha sido añadida en el sistema
                            </div>
                            <%}%>  
                        </label><br>
                        <label class="alert-danger">
                            ...
                            <div class="alert alert-danger">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                <strong>¡Error!</strong> No se ha podido añadir la receta
                            </div>    
                            <%}%>  
                        </label>
                        </form>
