                        ...
                        <form name="form1" method="post" action="Familiar"  >
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Crear Familiar</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="IDF">Identificación familiar </label>
                                            <input type="number" class="form-control form-control-user" name="IDF"  placeholder="Identificación del familiar"pattern="[0-9]{6,12}" required title="Solo se acepta números, cantidad min/max de números:6/12">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="NombreF">Nombres del familiar </label>
                                            <input type="text" class="form-control form-control-user" name="NombreF" placeholder="Nombres del familiar" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="ApellidoF"  placeholder="Apellidos del familiar" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="CorreoF" placeholder="Correo electrónico" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,25}" required title="Digite correctamente el correo">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="AdultoF">Identificación del adulto mayor</label>
                                            <select name="AdultoF" required class="form-control form-control-user">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <select type="number" class="form-control form-control-user"  required name="ParentescoF">
                                                <option selected value="">Seleccione el parentesco..</option>
                                    ...
                                    <input type="Hidden" value="3" name="IDU">            
                            ...
                            <label class="alert-primary">
                                ...
                                <div class="alert alert-success">
                                    ...
                                    <strong>Â¡Ãˆxito!</strong> El familiar ha sido añadido en el sistema
                                </div>
                                <%}%>  
                            </label>
                            <label class="alert-danger">
                                ...
                                <div class="alert alert-danger">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                    <strong>Â¡Error!</strong> No se ha podido añadir el familiar
                                </div>    
                                <%}%>  
                            </label>
                    </div>
