      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form name="form1" method="post" action="AdultoMayor">
             <div class="card shadow mb-4">
                <div class="card-header py-3">

                  <h6 class="m-0 font-weight-bold text-primary">Modificar Adulto Mayor</h6>
                </div>
                <div class="card-body">
                  ...
                  <%
              String id_adulto = request.getParameter("id");

                                        AdultoMayorVO aduVO = new AdultoMayorVO();
                                        AdultoMayorDAO aduDAO = new AdultoMayorDAO();

                                        ArrayList<AdultoMayorVO> listaAdulto = aduDAO.consultarIda(id_adulto);

                                        for (int i = 0; i < listaAdulto.size(); i++) {
                                            aduVO = listaAdulto.get(i);

        %>


            <input type="Hidden" name="IDAM" value="<%=aduVO.getIdAdult()%>">
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ID">Identificación adulto </label>
                    <input type="number" class="form-control form-control-user" name="ID" readonly value="<%=aduVO.getIdAdult()%>" placeholder="Identificación Adulto Mayor">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Adulto Mayor </label>
                      <input type="text" class="form-control form-control-user" name="NombreAM" placeholder="Nombres del Adulto Mayor"  value="<%=aduVO.getNombres_Adult()%>"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="digite correctamente el correo,Solo se acepta letras, cantidad máxima de letras: 30">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ApellidoAM">Apellidos del adulto Mayor </label>
                    <input type="text" class="form-control form-control-user" name="ApellidoAM"  placeholder="Apellidos Adulto Mayor" value="<%=aduVO.getApellidos_Adult()%>"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="digite correctamente el correo,Solo se acepta letras, cantidad máxima de letras: 30">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FechaAM">Fecha de Nacimiento </label>
                      <input type="date" class="form-control form-control-user" name="FechaAM"  value="<%=aduVO.getFecha_Adult()%>" required>
                </div>
                  </div>
                   ...
                   <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  		<label for="IDAM">Género del Adulto Mayor</label>
                    <select type="number" class="form-control form-control-user"  required name="GeneroAM">
                        <%if (aduVO.getGenero_Adult().equals("f") ) {%>
                    	<option value="f">Femenino</option>
                        <option value="f">Masculino</option>
                      <%} else if (aduVO.getGenero_Adult().equals("m")) {%>
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FotoF">Foto Del Adulto Mayor </label>
                      <input type="file" class="form-control form-control-user" required name="FotoF">
                </div>
