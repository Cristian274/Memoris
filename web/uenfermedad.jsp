  ...
  <%}%>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <!-- End of Topbar -->
<%
           String id_enf=request.getParameter("id");
           EnfermedadVO enfVO=new EnfermedadVO();
           EnfermedadDAO enDAO=new EnfermedadDAO();
           ArrayList<EnfermedadVO> listar=enDAO.consultariden(id_enf);
...
%>
          ...
          <div class="container-fluid">
            <form name="form1" method="post" action="Enfermedad">
                        
               <div class="card shadow mb-4">
                  <div class="card-header py-3">

                    <h6 class="m-0 font-weight-bold text-primary">Actualizar enfermedad</h6>
                  </div>
                  <div class="card-body">
                           
			<input type="Hidden" value="<%= enfVO.getId_Enf()%>" name="IDE">
                            <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label for="NombreE">Nombre Enfermedad </label>
                    <input type="text" class="form-control form-control-user" name="NombreE" value="<%=enfVO.getNom_Enf()%>" placeholder="Nombre Enfermedad" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                      <label for="SintomaE">Sintomas Enfermedad </label>
                      <input type="text" class="form-control form-control-user" name="SintomaE" value="<%=enfVO.getSint_Enf()  %>" placeholder="Sintomas Enfermedad" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 200">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label for="TratamientoE">Tratamientos  de la Enfermedad</label>
                    <input type="text" class="form-control form-control-user" name="TratamientoE" value="<%=enfVO.getTrat_Enf()  %>" placeholder="Tratamientos de la Enfermedad" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
                  </div>
