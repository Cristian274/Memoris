                ...
                <div id="content">
                        ...
                        <input type="hidden" name="FechaR" value="<%=año+"-"+mes+"-"+dia%>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control form-control-user" name="ObservacionR" placeholder="Observaciones" pattern="[A-Za-zñÑáéíóú\s]{2,199}" required title="Solo se acepta letras y solo se permiten 200 letras" >
                                        </div>
                                    </div>
                    ...
                    <label class="alert-primary">
                        ...
                        <div class="alert alert-success">
                            ...
                            <strong>¡Éxito!</strong> El reporte ha sido añadido en el sistema
                        </div>
                        <%}%>  
                    </label><br>
