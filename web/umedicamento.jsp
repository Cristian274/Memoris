        ...
        <div id="content">
          ...
          <!-- End of Topbar -->
	          ...
	          <div class="container-fluid">
	     			<form name="form1" method="post" action="Medicamento">
	             <div class="card shadow mb-4">
	                <div class="card-header py-3">

	                  <h6 class="m-0 font-weight-bold text-primary">Actualizar Medicamento</h6>
	                </div>
	                <%
                           String id_med = request.getParameter("id");
                                        ...
                                        ArrayList<MedicamentoVO> listaMedicamento = medDAO.consultariden(id_med);

                                        for (int i = 0; i < listaMedicamento.size(); i++) {
                                            medVO = listaMedicamento.get(i);
                        %>
	                
	                    <input type="hidden"  value="<%=medVO.getId_Med()%>"name="IDM" >
	             ...
	             <div class="form-group row">
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="NombreM">Nombre Medicamento </label>
	                      <input type="text" class="form-control form-control-user" name="NombreM" value="<%=medVO.getId_Med()%>"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="FechamM">Fecha vencimiento </label>
	                      <input type="date" class="form-control form-control-user" name="FechaM" value="<%=medVO.getFecha_Venci_Med()%>" required>
	                </div>
	            </div>
	                ...
	                <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  	<label for="CompoM">Composicion </label>
	                    <input type="file" class="form-control form-control-user" name="CompoM" value="<%=medVO.getComposi_Med()%>" required>
	                  </div>
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                  		<label for="CorreoF">Contraindicaciones </label>
	                      <input type="file" class="form-control form-control-user" name="ContraM" value="<%=medVO.getContraindi_Med()%>" requires>
	                  </div> 
	              </div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                      ...
	                      <input type="text" class="form-control form-control-user" name="CantidadM" value="<%=medVO.getCant_Med()%>" pattern="[0-9]{1,4}" required title="Solo se acepta números, cantidad min/max de números:1/4" >
	                      	</div>
	                      <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select class="form-control form-control-user" name="DosisM" required>
                                            ...
                                            <%if (medVO.getDosis_Med().equals("mg") ) {%>
                                            <option value="mg" >mg</option>
                                            <%} else if (medVO.getDosis_Med().equals("g")) {%>
                                            <option value="g">g</option>
                                            <%} else if (medVO.getDosis_Med().equals("ml")) {%>
	               ...
	               <div class="form-group row">
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="NombreLM">Nombre laboratorio </label>
	                      <input type="text" class="form-control form-control-user" name="NombreLM" value="<%=medVO.getNom_Lab_Med()%>"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
	                      	</div>
	                  ...
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    ...
	                    <select class="form-control form-control-user" name="ViaM" required="">
                                <option value="<%=medVO.getVia_Med()%>"><%=medVO.getVia_Med()%></option>
                                            <%if (medVO.getVia_Med().equals("Oral")) {%>
                                            <option value="Oral">Oral</option>
                                            <%} else if (medVO.getVia_Med().equals("Inyección")) {%>
	              ...
	              <label class="alert-primary">
	                        ...
	                        <strong>¡Èxito!</strong> El medicamento ha sido actualizado en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido actualizar el medicamento
	                    </div>    
	                                <%}%>  
	                            </label>
