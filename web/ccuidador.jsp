...
<%@page import="ModeloVO.CuidadorVO"%>
  ...
  <%}%>
       ...
       <form  name="form1" method="post" action="Cuidador" >
             <div class="card shadow mb-4">
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Crear Cuidador</h6>
                </div>
                <div class="card-body">
             ...
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="IDC">Identificación Cuidador </label>
                    <input type="number" class="form-control form-control-user" name="IDC"  placeholder="Identificación Cuidador" pattern="[0-9]{6,12}" required title="Solo se acepta números, cantidad min/max de números:6/12">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Cuidador </label>
                      <input type="text" class="form-control form-control-user" name="NombreC" placeholder="Nombres del Cuidador" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, cantidad máxima de letras: 30">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="form-control form-control-user" name="ApellidoC"  placeholder="Apellidos Cuidador"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, cantidad máxima de letras:30">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="TelefonoC">Teléfono </label>
                        <input type="number" class="form-control form-control-user" name="TelefonoC" placeholder="Teléfono"required  pattern="[0-9]{6,12}" title="Solo se acepta números, cantidad de numeros máximos:12" >
                </div>
                  </div>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="Email" class="form-control form-control-user" name="CorreoC"  placeholder="Ejemplo: Example12@gmail.com"pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,25}" required title="Digite correctamente el correo">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FotoC">Foto Del Cuidador </label>
                      <input type="file" class="form-control form-control-user" name="FotoC" required>
                </div>
                  </div>
                  
                    <input type="hidden" name="IDU" value="2">
    ...
    <label class="alert-primary">
	                        ...
	                        <strong>¡Éxito!</strong> El cuidador ha sido añadida en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido añadir el cuidador
	                    </div>    
	                                <%}%>  
	                            </label>
