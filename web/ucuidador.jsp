      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <form name="form1" method="post" action="Cuidador"  >
             <div class="card shadow mb-4">
                <div class="card-header py-3">

                  <h6 class="m-0 font-weight-bold text-primary">Modificar Cuidador</h6>
                </div>
                <div class="card-body">
                	 ...
                	 <%
                         String id=request.getParameter("id");
                          ...
                          CuidadorDAO enDAO=new CuidadorDAO();
                          ArrayList<CuidadorVO> listar=enDAO.consultariden(id);
                                for (int i=0;i<listar.size() ;i++ ) {
                                 cuiVO=listar.get(i);

        %>

          <input type="hidden" name="IDC" value="<%=cuiVO.getId_Cuid()%>">


                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ID">Identificación Cuidador </label>
                    <input type="number" class="form-control form-control-user" readonly name="ID" value="<%=cuiVO.getId_Cuid()%>"  placeholder="Identificación Cuidador" >
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Cuidador </label>
                      <input type="text" class="form-control form-control-user" name="NombreC" value="<%=cuiVO.getNomb_Cuid() %>" placeholder="Nombres del Cuidador" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="digite correctamente el correo,Solo se acepta letras, cantidad máxima de letras: 30">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="ApellidoAM">Apellidos del Cuidador </label>
                        <input type="text" class="form-control form-control-user" name="ApellidoC" value="<%=cuiVO.getApel_Cuid()  %>" placeholder="Apellidos Cuidador"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="digite correctamente el correo,Solo se acepta letras, cantidad máxima de letras: 30" >
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="TelefonoC">Teléfono </label>
                      <input type="number" class="form-control form-control-user" name="TelefonoC"value="<%=cuiVO.getTelefono_Cuid()  %>"pattern="[0-9]{6,10}" required title="Solo se acepta números, cantidad min/max de números:6/10" >
                </div>
                  </div>

                     <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="CorreoC">Correo Electrónico del Cuidador </label>
                        <input type="Email" class="form-control form-control-user" name="CorreoC"  placeholder="Ejemplo: Example12@gmail.com" value="<%=cuiVO.getEmail_Cuid()  %>"  pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,25}" required title="Digite correctamente el correo">
                  </div>
             
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FotoC">Foto Del Cuidador </label>
                        <input type="file" class="form-control form-control-user" name="FotoC" value="<%=cuiVO.getFoto_Cuid()%>" required >
                </div>
                  </div>
                 
                  
                  <input type="hidden"  name="IDU" value="<%=cuiVO.getId_usuario()%>" >
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="SCerrar">Cerrar Sesión</a>
          </div>
        </div>
      </div>
    </div>
