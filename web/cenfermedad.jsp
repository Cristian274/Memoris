          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Crear enfermedad</h6>
                </div>
                <div class="card-body">
            
                     <%int num=(int)(Math.random()*9999+1111);%>
                            <input type="Hidden" value="1" name="opcion">
                             <input type="Hidden" value="900" name="<%=num%>>">

                            <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label for="NombreE">Nombre Enfermedad </label>
                    <input type="text" class="form-control form-control-user" name="NombreE"  placeholder="Nombre Enfermedad"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras:30">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                      <label for="SintomaE">Sintomas Enfermedad </label>
                      <input type="text" class="form-control form-control-user" name="SintomaE" placeholder="Sintomas Enfermedad"pattern="[A-Za-zñÑáéíóú\s]{2,200}" required title="Solo se acepta letras, máxima cantidad de letras: 200">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                   ...
                   <textarea class="form-control form-control-user" name="TratamientoE"  placeholder="Tratamientos de la Enfermedad" pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima  cantidad de letras:200 "> </textarea>
                  </div>
...
<label class="alert-primary">
	                        ...
	                        <strong>¡Éxito!</strong> La enfermedad ha sido añadida en el sistema
	                    </div>
	                                <%}%>  
	                            </label><br>
	                        ...
	                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	                        <strong>¡Error!</strong> No se ha podido añadir la enfermedad
	                    </div>    
	                                <%}%>  
	                            </label>
    <!-- Logout Modal-->
