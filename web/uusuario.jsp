  ...
  <%}%>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
	     ...
	     <form name="form1" method="post" action="Usuario">
	             <div class="card shadow mb-4">
	                ...
	                <div class="card-body">
                           ...
                           String id = request.getParameter("id");
                                        ...
                                        ArrayList<UsuarioVO> listaMedicamento = usuDAO.consultarlog(id);

                                        for (int i = 0; i < listaMedicamento.size(); i++) {
                                            usuaVO = listaMedicamento.get(i);
                        %>
	                	
	                		
	                  	<!--<label for="IDU">ID usuario</label>-->
	                    <input type="hidden"value="<%=usuaVO.getId_usu()%>" name="IDU" >
	
	             <div class="form-group row">
	                 
	                  <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="NombreU">Nombre de Usuario</label>
	                      <input type="text" class="form-control form-control-user" name="nombre"  value="<%=usuaVO.getNom_usu()%>" placeholder="Correo electrónico" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,25}" required title="Digite correctamente el correo" >
	                </div>
	                <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="contra">Contraseña</label>
	                      <input type="text" class="form-control form-control-user" name="contra" value="<%=usuaVO.getCont_Usu()%>" pattern="[0-9A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras y números, máxima cantidad de carácteres: 30" >
	                      	</div>
	            </div>
	                  ...
	                  <div class="form-group row">
	                       ...
	                       <div class="col-sm-6 mb-3 mb-sm-0">
	                    	<label for="nocomple">Nombre Completo</label>
	                      <input type="nocomple" class="form-control form-control-user"  name="nocomple" value="<%=usuaVO.getNombrecomple()%>" placeholder="Ej: Manuel Rodriguez" pattern="[0-9A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, máxima cantidad de letras: 30">
	                </div>
	                <% if (usuVO.getRol().equals("1")) {%>
                    <div class="col-sm-6 mb-3 mb-sm-0">
                         
                        <label for="roles">Rol</label>
                      <select class="form-control form-control-user" name="roles" required>
                        
                          <%if (usuVO.getRol().equals("1")) {%>
                               <option value="1">Administrador</option>
                               <option value="2">Cuidador</option>
                                 <option value="3">Familiar</option>
                                 <%   } else if (usuVO.getRol().equals("2")) {%>
                                   <option value="2">Cuidador</option>
                                 <option value="3">Familiar</option>
                                 <option value="1">Administrador</option>
              ...
              <%} if (usuVO.getRol().equals("2") ||usuVO.getRol().equals("3")) {%>
                     <input type="hidden" name="roles" value="<%=usuVO.getRol()%>" >
                     <%}%>
