                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consulta usuario</h6>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <%
                                                ...
                                                ArrayList<UsuarioVO> listaUsuario = usuDAO.listarUsuario();
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= usuVO.getId_usu()%></td>
                                                    <td><%= usuVO.getNom_usu()%></td>
                                                    <td><%= usuVO.getCont_Usu()%></td>
                                                    <td><%= usuVO.getRol()%></td>
                                                    <td><%= usuVO.getNombrecomple()%></td>
                                                    <td> <a href="uusuario.jsp?id=<%=usuVO.getId_usu()%>">Modificar</a></i></td>
                                                </tr>
                                                <%}%>
                                            </tbody>
                                        </table>
