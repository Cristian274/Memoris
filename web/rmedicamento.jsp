...
%>
  ...
  <%}%>
          ...
          <div class="container-fluid">
               ...
               <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Consulta medicamento</h6>
                  </div>
                  <div class="card-body">
			   ...
			   <thead>
                                        ...
                                        <tbody>
                                           <%
                                                ...
                                                ArrayList<MedicamentoVO> listaMedicamento = medDAO.listarmedicamento();
                                            ...
                                            <tr>
                                                ...
                                                <td> <a href="umedicamento.jsp?id=<%=medVO.getId_Med()%>">Modificar</a></i></td>
    ...
    <label class="alert-danger">
                        ...
                        <strong>Â¡Error!</strong> El medicamento no existe en el sistema
                    </div>    
                                <%}%>  
                            </label>
    ...
    <label class="alert-danger">
                               ...
                               <div class="alert alert-danger">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Â¡Error!</strong> La alarma no existe en el sistema
                    </div>    
                                <%}%>  
                            </label>
</div>
