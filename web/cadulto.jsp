            ...
            <form name="form1" method="post" action="AdultoMayor">
             <div class="card shadow mb-4">
                <div class="card-header py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">Crear Adulto Mayor</h6>
                </div>
                <div class="card-body">
             <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  	<label for="IDAM">Identificación adulto </label>
                    <input type="number" class="form-control form-control-user" name="IDAM"  placeholder="Identificación Adulto Mayor" required  pattern="[0-9]{6,12}" title="Digite correctamente la identificaciòn,  cantidad de carácteres min/max: 6/12">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="NombreAM">Nombres del Adulto Mayor </label>
                      <input type="text" class="form-control form-control-user" name="NombreAM" placeholder="Nombres del Adulto Mayor"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="digite correctamente el correo,Solo se acepta letras, cantidad máxima de letras: 30">
                </div>
            </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <input type="text" class="form-control form-control-user" name="ApellidoAM"  placeholder="Apellidos Adulto Mayor"pattern="[A-Za-zñÑáéíóú\s]{2,30}" required title="Solo se acepta letras, digite correctamente los apellidos, máxima cantidad de carácteres: 30">
                  </div>
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    	<label for="FechaAM">Fecha de Nacimiento </label>
                      <input type="date" class="form-control form-control-user" name="FechaAM" title="La tercera edad son 55 años para las mujeres o 60 años si es hombre" required>
                </div>
                  </div>
                  ...
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <select required type="number" class="form-control form-control-user" name="GeneroAM">
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0">
                      ...
                      <input type="file" class="form-control form-control-user" name="FotoF" required>
                </div>
                  ...
                  <button class="btn btn-primary"> Añadir</button>
           		...
           		<label class="alert-primary">
                          ...
                          <strong>¡Éxito!</strong> El adulto mayor ha sido añdido en el sistema
                      </div>
                                  <%}%>  
                              </label><br>
                          ...
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                          <strong>¡Error!</strong> No se ha podido añadir el adulto mayor
                      </div>   
                                  <%}%>  
                              </label>
