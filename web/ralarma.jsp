                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                ...
                                <h6 class="m-0 font-weight-bold text-primary">Consulta alarma</h6>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    AlarmaDAO alaDAO = new AlarmaDAO();
                                                    ArrayList<AlarmaVO> listaAlarma = alaDAO.listarAlarma();

                                                    for (int i = 0; i < listaAlarma.size(); i++) {

                                                        alaVO = listaAlarma.get(i);
                                                %>


                                                <tr>

                                                    <td><%= alaVO.getId_Alarm()%></td>

                                                    <td><%= alaVO.getVia_Adminis_Alarm()%></td>
                                                    <td><%= alaVO.getCantidad_Alarm()%></td>
                                                    <td><%= alaVO.getDosis_Medica_Alarm()%></td>
                                                    <td><%= alaVO.getFrecuencia_Medica_Alarm()%></td>
                                                    <td><%= alaVO.getFecha_Inicio_Alarm()%></td>
                                                    <td><%= alaVO.getFecha_Final_Alarm()%></td>
                                                    <td><%= alaVO.getId_Cuidador()%></td>
                                                    <td><%= alaVO.getId_Medicamento()%></td>
                                                    <td> <a href="ualarma.jsp?id=<%=alaVO.getId_Alarm()%>">Modificar</a></i></td>
